...
<p>
  Простой чат где можно переписываться с любым пользователем, что-то типо аналога телеграмма, но для начала нужно зарегистрироваться или войти уже в существующий аккаунт.
  При первом заходе может быть долгая загрузка при авторизации (до 1 минуты), а сообщения могут отправлятся с небольшой задержкой (1- 5 секунд).
